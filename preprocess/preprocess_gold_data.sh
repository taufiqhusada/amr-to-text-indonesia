...
# rule_based_traversal_with_tree_level
python preprocess/preprocess.py --source_file_path data/raw_data_akhyar/amr_simple_amany_v2.txt --result_amr_path data/preprocessed_data/rule_based_traversal_with_tree_level/train.amr.txt --result_sent_path data/preprocessed_data/rule_based_traversal_with_tree_level/train.sent.txt --mode rule_based_traversal_with_tree_level
python preprocess/preprocess.py --source_file_path data/raw_data_ilmy/amr_simple_dev.txt --result_amr_path data/preprocessed_data/rule_based_traversal_with_tree_level/dev.amr.txt --result_sent_path data/preprocessed_data/rule_based_traversal_with_tree_level/dev.sent.txt --mode rule_based_traversal_with_tree_level
python preprocess/preprocess.py --source_file_path data/raw_data_ilmy/amr_simple_test.txt --result_amr_path data/preprocessed_data/rule_based_traversal_with_tree_level/test.amr.txt --result_sent_path data/preprocessed_data/rule_based_traversal_with_tree_level/test.sent.txt --mode rule_based_traversal_with_tree_level
