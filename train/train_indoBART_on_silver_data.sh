...
### python train_indoBART.py --model_type indo-bart --n_epochs 3 --data_folder ../data/preprocessed_data/linearized_penman  --result_folder result/result_linearized_penman \
