...
### python train_indoT5.py --model_type indo-t5 --n_epochs 3 --data_folder ../data/preprocessed_data/linearized_penman  --result_folder result/result_linearized_penman \
