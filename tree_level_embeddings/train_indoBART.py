...
import sys
import torch
from custom_transformers.models.mbart import MBartForConditionalGeneration
...
if __name__=='__main__':
    ...
    if (args.resume_from_checkpoint):
        ...
        model = MBartForConditionalGeneration.from_pretrained(os.path.join(saved_model_folder_path, 'model'), additional_config = {'tree_max':max_seq_len_amr})
    else:
        model = MBartForConditionalGeneration.from_pretrained('indobenchmark/indobart', additional_config = {'tree_max':max_seq_len_amr})
