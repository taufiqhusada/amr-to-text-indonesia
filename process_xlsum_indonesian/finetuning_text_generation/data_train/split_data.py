...
# tree_level
with open('full.amr.txt.tree_level', encoding='utf8') as f:
    data = f.readlines()
...
with open('train.amr.txt.tree_level', encoding='utf8', mode='w+') as f:
    for item in train:
        f.write(item)
with open('dev.amr.txt.tree_level', encoding='utf8', mode='w+') as f:
    for item in dev:
        f.write(item)
with open('test.amr.txt.tree_level', encoding='utf8', mode='w+') as f:
    for item in test:
        f.write(item)
